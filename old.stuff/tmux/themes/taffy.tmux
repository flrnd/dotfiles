...
setw -g window-style 'bg=#2f343f'
setw -g window-active-style 'bg=#2f343f'
setw -g pane-active-border-style ''

## highlight activity in status bar
setw -g window-status-activity-fg "#70c0b1"
setw -g window-status-activity-bg "#2f343f"
